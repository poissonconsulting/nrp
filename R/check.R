...
check_ems_raw_data <- function(data, exclusive = FALSE, order = FALSE){
  check_data(
    ...
    values = list(
         EMS_ID = as.character(),
         MONITORING_LOCATION = as.character(),
         LATITUDE = as.double(),
         LONGITUDE = as.double(),
         LOCATION_TYPE = as.character(),
         COLLECTION_START = as.double(),
         COLLECTION_END = as.double(),
         LOCATION_PURPOSE = as.character(),
         PERMIT = as.double(),
         PERMIT_RELATIONSHIP = as.character(),
         DISCHARGE_TO = as.character(),
         REQUISITION_ID = as.character(),
         SAMPLING_AGENCY = as.character(),
         ANALYZING_AGENCY = as.character(),
         COLLECTION_METHOD = as.character(),
         SAMPLE_CLASS = as.character(),
         SAMPLE_STATE = as.character(),
         SAMPLE_DESCRIPTOR = as.character(),
         PARAMETER_CODE = as.character(),
         PARAMETER = as.character(),
         ANALYTICAL_METHOD_CODE = as.character(),
         ANALYTICAL_METHOD = as.character(),
         RESULT_LETTER = as.character(),
         RESULT = as.character(),
         UNIT = as.character(),
         METHOD_DETECTION_LIMIT = as.character(),
         QA_INDEX_CODE = as.character(),
         UPPER_DEPTH = as.character(),
         LOWER_DEPTH = as.character(),
         TIDE = as.character(),
         AIR_FILTER_SIZE = as.character(),
         AIR_FLOW_VOLUME = as.character(),
         FLOW_UNIT = as.character(),
         COMPOSITE_ITEMS = as.character(),
         CONTINUOUS_AVERAGE = as.character(),
         CONTINUOUS_MAXIMUM = as.character(),
         CONTINUOUS_MINIMUM = as.character(),
         CONTINUOUS_UNIT_CODE = as.character(),
         CONTINUOUS_DURATION = as.character(),
         CONTINUOUS_DURATION_UNIT = as.character(),
         CONTINUOUS_DATA_POINTS = as.character(),
         TISSUE_TYPE = as.character(),
         SAMPLE_SPECIES = as.character(),
         SEX = as.character(),
         LIFE_STAGE = as.character(),
         BIO_SAMPLE_VOLUME = as.character(),
         VOLUME_UNIT = as.character(),
         BIO_SAMPLE_AREA = as.character(),
         AREA_UNIT = as.character(),
         BIO_SIZE_FROM = as.character(),
         BIO_SIZE_TO = as.character(),
         SIZE_UNIT = as.character(),
         BIO_SAMPLE_WEIGHT = as.character(),
         WEIGHT_UNIT = as.character(),
         BIO_SAMPLE_WEIGHT_FROM = as.character(),
         BIO_SAMPLE_WEIGHT_TO = as.character(),
         WEIGHT_UNIT_1 = as.character(),
         SPECIES = as.character(),
         RESULT_LIFE_STAGE = as.character()),
    exclusive = exclusive, order = order
  )
}

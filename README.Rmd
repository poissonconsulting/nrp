...
For simplicity, this demo uses an empty, temporary database to read and write to, and uses some test data that travels with the package. When connecting to a proper database, you don't need to create a database connection at the start, just provide the file path to the database for the argument "db_path" in all function calls.
